...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        DownFilmDao.createTable(db, ifNotExists);
        DownloadDao.createTable(db, ifNotExists);
        DurationDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        DownFilmDao.dropTable(db, ifExists);
        DownloadDao.dropTable(db, ifExists);
        DurationDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DownFilmDao.class);
        registerDaoClass(DownloadDao.class);
        registerDaoClass(DurationDao.class);
