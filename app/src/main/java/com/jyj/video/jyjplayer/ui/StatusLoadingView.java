...
public class StatusLoadingView extends View {
    ...
    public StatusLoadingView(Context context, AttributeSet attrs) {
    ...
    public StatusLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {

        super(context, attrs, defStyleAttr);

        progressColor = SkinManager.getInstance().getPrimaryColor();

        loadSuccessColor = SkinManager.getInstance().getPrimaryColor();

        loadFailureColor = SkinManager.getInstance().getPrimaryColor();

        progressWidth = DrawUtils.dp2px(4);

        progressRadius = DrawUtils.dp2px(26);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate(progressWidth, progressWidth);   //将当前画布的点移到getPaddingLeft,getPaddingTop,后面的操作都以该点作为参照点
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            width = (int) (2 * progressRadius + progressWidth*3 + getPaddingLeft() + getPaddingRight());
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            height = (int) (2 * progressRadius + progressWidth*3 + getPaddingTop() + getPaddingBottom());
