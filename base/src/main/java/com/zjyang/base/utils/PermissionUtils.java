...
public class PermissionUtils {
     ...
     * 检查是否有相应的权限
     */
    public boolean grantPermission(String permissionName){
    ...
    private boolean checkPermissionAllGranted(String[] permissions) {
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(BaseApp.sContext, permission) != PackageManager.PERMISSION_GRANTED) {
